  ...
  func performActionWithPlacemark(placemark:CLPlacemark?,error:String?) {
    ...
    if error != nil {
      ...
      dispatch_async(dispatch_get_main_queue(), { () -> Void in
        ...
        //dispatch_async: Submits a block for asynchronous execution on a dispatch queue.
        //dispatch_get_main_queue: Returns the default queue that is bound to the main thread.
